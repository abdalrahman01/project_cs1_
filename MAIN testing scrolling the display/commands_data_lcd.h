...
#define TEXT_MODE 0x80 //OR Mode
#define TEXT_ON_GRAPHIC_OFF 0x94
#define CURSOR_ON_BLINK_ON 0x93
#define DATA_WRITE_AND_INCREMENT_ADP 0xC0 // write then move cursor to right
#define DATA_WRITE_AND_NON_VARIABLE_ADP 0xC4 // write without moving cursor
